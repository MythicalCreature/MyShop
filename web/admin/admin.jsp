		...
		<div class="page_main">
			<script type="text/javascript">
				...
				$("#showGoods").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/product?method=getProductType");
				});
				$("#addGoods").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/type?method=getTypeList");
				});
				$("#showOrder").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/orders?method=getAllOrder");
				});
			</script>
